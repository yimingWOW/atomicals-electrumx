        ...
        for service in services:
            ...
            if service.protocol == 'http':
                ...
                try:
                    ...
                    app.router.add_get('/proxy/blockchain.atomicals.txhash', handler.atomicals_txhash)
                    ...
                    app.router.add_post('/proxy/blockchain.atomicals.txhash', handler.atomicals_txhash)
