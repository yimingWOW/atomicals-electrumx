...
class BlockProcessor:
    ...
    def color_ft_atomicals_regular_legacy(self, ft_atomicals, tx_hash, tx, tx_num, operations_found_at_inputs, atomical_ids_touched, height, live_run):
        self.logger.info(f'color_ft_atomicals_regular_legacy called')
    ...
    def color_ft_atomicals_regular_new(self, ft_atomicals, tx_hash, tx, tx_num, operations_found_at_inputs, atomical_ids_touched, height, live_run):
    ...
    def color_ft_atomicals_regular(self, ft_atomicals, tx_hash, tx, tx_num, operations_found_at_inputs, atomical_ids_touched, height, live_run):
        if height >= self.coin.ATOMICALS_ACTIVATION_HEIGHT_DMINT:
            return self.color_ft_atomicals_regular_new(ft_atomicals, tx_hash, tx, tx_num, operations_found_at_inputs, atomical_ids_touched, height, live_run)
        else:
    ...
    def create_or_delete_subrealm_payment_output_if_valid(self, tx_hash, tx, tx_num, height, atomicals_spent_at_inputs, Delete=False):
        ...
        if found_atomical_id_for_potential_subrealm:
            ...
            nft_atomicals, ft_atomicals = self.build_atomical_type_structs(atomicals_spent_at_inputs)
            atomical_id_to_output_index_map = calculate_outputs_to_color_for_ft_atomical_ids_v2(ft_atomicals, tx, 0)
